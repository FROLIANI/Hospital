...
<head>
  ...
  <meta name="copyright" content="INC Frolian, https://frolian.solo.co.tz/">

  <title>Inc-Health</title>
...
<body>
  ...
  <header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +255 718 658 450</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span>froliernest98@gmail.com</a>
            </div>
          </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="#"><span class="text-primary">Inc</span>-Health</a>
        ...
        <form action="#">
          <div class="input-group input-navbar">
            ...
            <input type="text" class="form-control" aria-describedby="icon-addon1">
          </div>
        </form>
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp">Get in Touch With Us</h1>

      <form class="contact-form mt-5" action="{{url('contact')}}" method="GET" enctype="multipart/form-data">
        <div class="row mb-3">
          @csrf
          ...
          <div class="col-sm-6 py-2 wow fadeInRight">
            ...
            <input type="number" id="phonenumber" name="phone" class="form-control" placeholder=" phone Number" required>
          </div>
          ...
          <div class="col-12 py-2 wow fadeInUp">
            ...
            <textarea id="message" class="form-control" name="message" rows="8" placeholder="Enter Message" required></textarea>
          </div>
